...
Sweet Moments is my final milestone project. It is a Full-Stack Django Frameworks ecommerce store. Users can browse for vegan sweets and make an order , submit a payment via Stripe. All products and images were added through the Django admin dashboard. 
